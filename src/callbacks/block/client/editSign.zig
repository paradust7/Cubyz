...
pub fn run(_: *anyopaque, params: main.callbacks.ClientBlockCallback.Params) main.callbacks.Result {
	...
	main.block_entity.BlockEntityTypes.@"cubyz:sign".StorageClient.mutex.lockUncancelable(main.io);
	defer main.block_entity.BlockEntityTypes.@"cubyz:sign".StorageClient.mutex.unlock(main.io);
